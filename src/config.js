...
const HOST_URL = 'https://afrisalltd.gallerycdn.vsassets.io'

const AUTH0_URL = 'https://topcoder-dev.auth0.com/oauth'
const AUTH0_DEVICE_CODE_URL = `${AUTH0_URL}/device/code`
const AUTH0_GET_TOKEN_URL = `${AUTH0_URL}/token`

const AUTH0_CLIENT_ID = `XDw5NTMOru5D7XOu77kAafblpnKjl4oQ`
const AUTH0_SCOPE = `openid profile offline_access`
const AUTH0_AUDIENCE = `https://api.topcoder.com/`
